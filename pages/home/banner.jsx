...
import bannerImg from '../../src/assets/book/banner.png';
  ...
  return (
    <div className='flex flex-col md:flex-row-reverse py-16 justify-between items-center gap-12'>
      <div className='md:w-1/2 w-full flex items-center md:justify-end'>
        <img src={bannerImg} alt='cover'></img>
      </div> 
      <div className='md:w-1/2 w-full'>
        ...
        <button className='bg-yellow-400  rounded-sm px-6 py-2 hover:bg-yellow-500 transition'>
        Subscribe
        </button>
      </div>
