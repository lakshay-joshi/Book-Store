...
import footerLogo  from "../src/assets/book/footer-logo.png"
  ...
  return (
    <footer className="bg-gray-900 text-white py-10 px-4">
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="md:w-1/2 w-full">
          <p className="mb-4 hover:text-yellow-400">
          ...
          <div className="flex">
            ...
            />
            <button className="bg-yellow-400 px-6 py-2 rounded-r-md hover:bg-yellow-400-dark">
              Subscribe
            </button>
          </div>
        </div>
